...
const Header: React.FC = () => {
  ...
  return (
    <div>
      ...
      {menuOpen && (
        <div className="fixed right-0 w-3/4 top-[80px] p-2 shadow bg-[#FFFFFA] h-screen z-[9999] flex flex-col">
          ...
          <Link
            href={"/register"}
            className="bg-[#2A6041] mt-8 text-white px-7 py-2.5 text-center text-sm font-bold rounded-xl xl:px-7 xl:py-2.5 xl:text-base"
            onClick={closeMenu}
          >
            Sign up
          </Link>
